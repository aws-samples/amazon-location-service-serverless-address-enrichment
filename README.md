...
This repository accompanies a post from the AWS Compute Compute Blog [*Enriching addresses with AWS Lambda and the Amazon Location Service*](https://aws.amazon.com/blogs/compute/validating-addresses-with-aws-lambda-and-the-amazon-location-service/). The repository contains a SAM tempalte for deploying a Serverless Address Enrichment pipeline using Amazon S3, AWS Lambda, and Amazon Location Service.
